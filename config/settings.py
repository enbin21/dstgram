...
SECRET_KEY = 'j1ne*(q$ks==6784yeo@xprq+3-8aq4)+$z-22xy*gnnmr=p4!'
...
DISQUS_WEBSITE_SHORTNAME = 'dstagram-enbin' # Disqus 사이트에 작성한 이름을 써야함
...
AWS_S3_FILE_OVERWRITE = False # 같은 이름 파일이 있는 경우 덮어 쓸지 결정
